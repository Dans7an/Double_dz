...
public class Board {
    ...
    public char[][] exampleBoard = { // our board
            {'1', '|', '2', '|', '3'},
            {'_', '+', '_', '+', '_'},
            {'4', '|', '5', '|', '6'},
            {'_', '+', '_', '+', '_'},
    ...
    // adds the winning combos to the winning combos list
    static {
    ...
    // handles playing against a fellow human
    public void multiPlayer(List<Integer> selectedPosition, List<Integer> availablePosition) {
        boolean isPlayer2PositionValid = true;  // player 1 code
        while (true) {
    ...
    // handles player against the computer
    ...
    // places the letter on the board
    ...
    // creates available positions at the beginning of the game
